...
echo -e "  Auther : ${green}Arya vpn® ${NC}${YELLOW}(${NC} ${green}vpn Tunneling ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
expx=$(curl https://raw.githubusercontent.com/Jatimpark/permission/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Jatimpark/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Jatimpark/permission/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Jatimpark/permission/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/sukarnacell"},{"text":"Contack","url":"wa.me/62895339170463"}]]}'
...
wget https://raw.githubusercontent.com/Jatimpark/hp/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget https://raw.githubusercontent.com/Jatimpark/hp/main/Cdy/menu.zip
unzip menu.zip
chmod +x menu/*
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m              ----[ BLITAR PUSAT ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Whatsapp : 081931615811 \e[0m"
echo -e "\e[95;1m  Facebook : Arya Blitare \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
